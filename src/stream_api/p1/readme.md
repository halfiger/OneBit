...
На вході: List<String> list = List.of("A", "B", "C");
Умова: Привести слова до lower-case
і відсортувати алфавітно.
Повернути: List <String>
...
На вхід: List<String> list = List.of("Agava", "Bob", "Cola");
...
Рішення:
    ...
    public String practice3 () {
        List<String> list = List.of("Agava", "Bob", "Cola");
...
1.5 — Витягти унікальні відсортовані цифри з рядка (sorted unique)
